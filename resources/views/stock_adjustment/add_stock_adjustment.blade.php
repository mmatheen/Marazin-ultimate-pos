                ...
                <form id="stockAdjustmentForm">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control" id="adjustment_date" name="date"
                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="input-group">
                                ...
                                <input type="text" id="productSearchInput" class="form-control"
                                    placeholder="Select a location first" disabled
                                    title="Select a location to enable product search">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="totalAmountRecovered"
                                name="total_amount_recovered" value="0">
                        </div>
                        <div class="col-md-6">
