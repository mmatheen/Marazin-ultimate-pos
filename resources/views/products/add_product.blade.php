                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <div class="input-group local-forms">
                                                        ...
                                                        <button class="btn btn-outline-primary" type="button"
                                                            data-bs-toggle="modal" data-bs-target="#addModal2"
                                                            id="button-addon1"><i class="fas fa-plus-circle"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                        <label>Business Locations <span class="star-red">*</span></label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                        <label>Business Locations <span class="star-red">*</span></label>
                                                        <select class="form-control input-tags form-select select" data-role="tagsinput" id="services">
                                                            <option selected disabled>Please Select Business Locations </option>
                                ...
                                <div class="row align-items-center">
                                    <form class="px-3" action="#">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group local-forms">
                                                    <label>Service staff timer/Preparation time (In minutes)<span
