...
@section('content')
    ...
    <script>
        window.taxRates = @json(\Illuminate\Support\Facades\Schema::hasTable('tax_rates') ? \App\Models\TaxRate::active()->get(['id', 'name', 'rate'])->toArray() : []);
    </script>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <div class="form-group local-forms">
                                                        ...
                                                        <input class="form-control" id="edit_sku" name="sku"
                                                            type="text" placeholder="Product SKU" autocomplete="off">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <div class="form-group local-forms">
                                                        ...
                                                        <div class="input-group">
                                                            <select
                                                                class="form-control form-select selectBox multiple-location"
                                                ...
                                                <div class="mb-5">
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input" name="stock_alert"
                                                            type="checkbox" id="edit_stock_alert" checked value="1">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="invoices-upload-btn">
                                                            <input type="file" accept="image/*" name="product_image"
                                                                id="file" class="hide-input show-picture">
                                                    ...
                                                    <div class="my-4 col-md-12 d-flex justify-content-center">
                                                        <img id="product-selectedImage"
                                                            ...
                                                            alt="Selected Image" width="200px" class="img-thumbnail"
                                                            height="200px">
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="form-check ms-3">
                                                            <input type="hidden" name="is_imei_or_serial_no"
                                                                value="0">
                                                            <input class="form-check-input" name="is_imei_or_serial_no"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <div class="form-check ms-3">
                                                            ...
                                                            <input class="form-check-input" name="is_for_selling"
                                                                type="checkbox" value="1" id="Not_for_selling">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="mb-3">
                                                            <div class="form-group local-forms">
                                                                ...
                                                                <input class="form-control" id="edit_pax" name="pax"
                                                    ...
                                                    <div class="row g-3 mb-3">
                                                        <div class="col-md-6">
                                                            <div class="form-group local-forms">
                                                                ...
                                                                <select id="edit_applicable_tax" class="form-control form-select selectBox">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text" id="edit_special_price"
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="number"
                                                                                ...
                                                                                class="form-control" placeholder="Rs .00">
                                                                            <span class="text-danger"
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="number" id="edit_retail_price"
