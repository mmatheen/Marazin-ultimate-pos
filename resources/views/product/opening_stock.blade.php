                        ...
                        <div class="card card-table">
                            <div class="card-body">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="submitOpeningStock-saveAndAddAnother"
                                        class="btn btn-success">Save and Add Another</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                    ...
                    <button type="button" class="btn btn-sm btn-info float-end text-white" id="autoFillImeis">Auto Fill
                        Rows</button>
