...
@section('content')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (priceSelection && additionalContent) {
                priceSelection.addEventListener('change', function(event) {
                    const selectedOption = event.target.value;
    
                    additionalContent.innerHTML = ''; // Clear previous content
    
                    if (selectedOption === 'Percentage') {
                        const percentageField = document.createElement('div');
                        percentageField.classList.add('mb-3');
                        ...
                        `;
                        additionalContent.appendChild(percentageField);
                    } else if (selectedOption === 'Selling Price Group') {
                        const nothingParagraph = document.createElement('p');
                        nothingParagraph.textContent = 'Nothing';
                        additionalContent.appendChild(nothingParagraph);
                    }
                });
            } else {
                console.error('Either priceselection or additional-content element is missing.');
            }
        });
    </script>
@endsection
