...
function addProductToTable(product) {
    ...
    if (existingRow.length > 0) {
        ...
        const initialQuantity = product.purchases[0].quantity; // Use the quantity from the purchase information
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response && response.purchase_return) {
                ...
                // Ensure the element exists before setting the property
                if (span) {
