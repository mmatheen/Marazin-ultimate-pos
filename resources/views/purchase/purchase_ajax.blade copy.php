    ...
    $(document).ready(function() {
        ...
        var purchaseValidationOptions = {
            ...
            messages: {
                ...
                services: { required: "Business Location is required" },
                duration: {
...
// Ensure the payment_method field is included
            ...
            formData.append('purchase_date', purchaseDate); // Ensure the date is in YYYY-MM-DD format
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 400) {
                        ...
                        resetFormAndValidation(); // Reset the form and validation
                    }
                },
