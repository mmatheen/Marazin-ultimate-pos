...
@section('content')
    <div class="content container-fluid">
                                            ...
                                            <div class="mb-3">
                                                <div class="input-group local-forms">
                                                    ...
                                                    <button class="btn btn-outline-primary" type="button"
                                                        data-bs-toggle="modal" data-bs-target="#addModal" id="button-addon1"><i
                    ...
                    <div class="card-body">
                        <div class="page-header">
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-md-3">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#new_product">Add New Product</button>
                                </div>
                                ...
                                <div class="col-4 col-xs-12">
                                    <div class="mb-3">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" type="text" placeholder="Shipping Details">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4 col-xs-12">
        ...
        {{-- Add modal row --}}
        <div class="row">
            <div class="modal fade" id="new_product" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="form-group">
                                                                    <label>Business Locations <span
                                                                            class="star-red">*</span></label>
                                                                    <select
                                                                        class="form-control input-tags form-select select"
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="form-check ms-3">
                                                                    <input class="form-check-input" type="checkbox" checked
                                                                         id="isActive" onclick="toggleLoginFields2(id,null,'.hidden2')">
