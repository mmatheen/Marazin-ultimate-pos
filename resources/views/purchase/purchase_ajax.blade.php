<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Function to fetch locations using AJAX
...
// Function to fetch all product data and initialize autocomplete
            ...
            if (data.status === 200 && Array.isArray(data.stocks)) {
                allProducts = data.stocks.map(stock => {
                    ...
                    return {
                        ...
                        purchase_message: stock.purchase_message
                    };
                });
...
// Function to initialize autocomplete for product search input
function initAutocomplete(allProducts) {
...
function addProductToTable(product) {
    ...
    <tr data-id="${product.id}">
        ...
        <td class="product-name">${product.name || '-'} <br>Current stock: ${product.quantity || '0'}</td>
        <td><input type="number" class="form-control purchase-quantity" value="1" min="1"></td>
        <td><input type="number" class="form-control product-price" value="${product.price || '0'}" min="0"></td>
        ...
        <td><input type="number" class="form-control profit-margin" value="${product.profit_margin || '0'}" min="0"></td>
    ...
    $newRow.find('.purchase-quantity, .discount-percent, .product-price, .profit-margin').on('input', function() {
        updateRow($newRow);
        updateFooter();
    });
