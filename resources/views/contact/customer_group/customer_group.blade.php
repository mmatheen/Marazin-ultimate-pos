                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <div class="form-group local-forms">
                                        ...
                                        <input id="edit_customerGroupName" name="customerGroupName" class="form-control"
                            ...
                            <div class="col-md-12" style="display: none;">
                                <div class="form-group local-forms">
                                    <label for="selling_price_group_id">Selling Price Group<span
                                            class="login-danger"></span></label>
                                    <select class="form-control" id="edit_selling_price_group_id"
                                        ...
                                        @foreach ($SellingPriceGroups as $SellingPriceGroup)
                                            <option value="{{ $SellingPriceGroup->id }}">{{ $SellingPriceGroup->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-group local-forms">
                                        <label for="calculationPercentage">Calculation Percentage (%)<span
                                                class="login-danger"></span></label>
                                        <input class="form-control" id="edit_calculationPercentage"
