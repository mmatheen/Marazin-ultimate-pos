...
@section('content')
                        ...
                        <form id="addAndEditForm" method="POST" action="">
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <div class="form-group local-forms">
                                                ...
                                                <input id="customerGroupName" name="customerGroupName" class="form-control"
                                    ...
                                    <div class="col-md-12" id="sellingPriceGroup">
                                        <div class="form-group local-forms">
                                            <label>Selling Price Group<span class="login-danger"></span></label>
                                            <select class="form-control form-select select" name="sellingPriceGroup">
                                    ...
                                    <div class="col-md-12" id="calculationPercentage">
                                        <div class="mb-3">
                                            <div class="form-group local-forms">
                                                <label>Calculation Percentage (%)<span class="login-danger"></span></label>
                                                <input class="form-control" name="calculation"
                                                    type="number" placeholder="Calculation Percentage (%)">
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let priceselection = document.getElementById('priceselection');
            ...
            // calculationPercentage.style.display = 'none';
            ...
            priceselection.addEventListener('change', function() {
                ...
                // Show or hide containers based on the selected value 
                if (selectedValue === 'Percentage') {
                    calculationPercentage.style.display = 'block';
                    sellingPriceGroup.style.display = 'none';
