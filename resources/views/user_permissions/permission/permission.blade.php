...
<div class="content container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="students.html">Permissions</a></li>
            ...
            <div class="card card-table">
                <div class="card-body">
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                ...
                                <button type="button" class="btn btn-outline-info " id="addPermissionButton">
                    ...
                    <div class="table-responsive">
                        <table id="permission" class="datatable table table-stripped" style="width:100%">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Name</th>
    ...
    {{-- Add/Edit modal row --}}
    <div class="row">
        <div id="addAndEditPermissionModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <form id="addAndUpdateForm">
                            ...
                            <div class="mb-3">
                                <div class="form-group local-forms">
                                    ...
                                    <input class="form-control" id="edit_group_name" name="group_name" type="text" placeholder="Enter Group Name">
...
@include('user_permissions.permission.permission_ajax')
@endsection
