...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="modal fade" id="addAndEditSalesCommissionModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" id="edit_email" name="email" type="text" placeholder="Email">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" type="text" id="edit_contact_number" name="contact_number" placeholder="Contact Number">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" id="edit_sales_commission_percentage" name="sales_commission_percentage" placeholder="Sales Commission Percentage (%)">
                                                <span class="text-danger" id="sales_commission_percentage_error"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
