                    ...
                    if ($.fn.DataTable.isDataTable('#salesTable')) {
                        ...
                        const table = $('#salesTable').DataTable({
                            ...
                            buttons: [{
                                    ...
                                    pageSize: 'A4',
                                    filename: () => 'daily_sales_details_' + new Date().toISOString().slice(
                                        0, 10),
                                    exportOptions: {
                                        columns: ':visible'
                                    },
                                    customize: function(doc) {
                                        ...
                                        const footerRow = $('#salesTable tfoot tr').clone();
                                        const footerData = [];
                                        footerRow.find('th').each(function() {
                                            footerData.push($(this).text());
                                        });
                                        doc.content[1].table.body.push(footerData);
                                ...
                                },
                                {
                                    ...
                                    customize: function(win) {
                                        $(win.document.body).find('table').append($('#salesTable tfoot')
                                            .clone());
