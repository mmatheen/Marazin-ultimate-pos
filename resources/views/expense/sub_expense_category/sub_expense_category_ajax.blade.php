    ...
    $(document).ready(function() {
        ...
        var addAndUpdateValidationOptions = {
            ...
            messages: {
                ...
                subExpenseCategoryname: {
                    required: "Sub Expense Category Name is required",
                },
                main_expense_category_id: {
                    required: "Parent Expense Category is required",
                },
        ...
        function showFetchData() {
            $.ajax({
                url: '/sub-expense-category-get-all',
                type: 'GET',
                dataType: 'json',
        ...
        $(document).on('click', '.edit_btn', function() {
            var id = $(this).val();
            $('#modalTitle').text('Edit Sub Expense Category');
            ...
            $.ajax({
                url: '/sub-expense-category-edit/' + id,
                type: 'get',
                success: function(response) {
        ...
        $('#addAndUpdateForm').submit(function(e) {
            ...
            let url = id ? '/sub-expense-category-update/' + id : '/sub-expense-category-store';
        ...
        $(document).on('click', '.confirm_delete_btn', function() {
            ...
            $.ajax({
                url: '/sub-expense-category-delete/' + id,
                type: 'delete',
                headers: {
                    'X-CSRF-TOKEN': csrfToken
                },
