                ...
                <div class="modal-body">
                    ...
                    <form id="addAndUpdateForm">
                        ...
                        <div class="collapse" id="moreinformation1">
                            ...
                            <div class="col-sm-12 mb-5">
                                <div class="card-body"
                                    style="background: rgba(223, 221, 221, 0.651); border-radius: 5px">
                                    <div class="col">
                    ...
                    <div class="col-md-12">
                        <div class="form-group local-forms">
                            ...
                            <select id="edit_main_category_id" name="main_expense_category_id"
                                class="form-control select2Box form-select select">
                                <option selected disabled>Please Select </option>
                                @foreach ($MainCategories as $MainCategory)
                                    <option value="{{ $MainCategory->id }}">{{ $MainCategory->expenseParentCatergoryName }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            <div class="form-group local-forms">
                                ...
                                <input id="edit_subExpenseCategoryname" name="subExpenseCategoryname" class="form-control"
                                    type="text" placeholder="sub Expense category">
                                <span class="text-danger" id="subExpenseCategoryname_error"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            <div class="form-group local-forms">
                                <label>Expense category code<span class="login-danger">*</span></label>
                                <input id="edit_subExpenseCategoryCode" name="subExpenseCategoryCode" class="form-control"
                                    type="text" placeholder="Expense Category Code">
                                <span class="text-danger" id="subExpenseCategoryCode_error"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
