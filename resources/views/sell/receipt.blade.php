...
<body>
    <div class="receipt-container">
        ...
        <table class="products-table">
            ...
            <tbody>
                {{-- Batch and IMEI data already loaded from controller --}}
                ...
                @foreach ($displayItems as $index => $item)
                    <tr class="product-name-row">
                        ...
                        <td colspan="4" class="product-name">
                            {{ $item['product']->custom_name ?? $item['product']->product->product_name }}
                    ...
                    <tr class="product-details-row">
                        ...
                        <td class="quantity">
                            ...
                            <span>{{ $fmtQty($item['quantity']) }}</span>
                            @if(isset($item['free_quantity']) && $item['free_quantity'] > 0)
                                <span> + {{ $fmtQty($item['free_quantity']) }} free</span>
                            @endif
        ...
        <section class="stats-section">
            ...
            <div class="stat-box">
                ...
                @endphp
                <span class="stat-number">{{ $fmtQ($totalQty + $totalFreeQty) }}</span>
