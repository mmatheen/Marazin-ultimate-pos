    ...
    <div class="py-4">
          ...
          <tbody>
            <tr>
              <td class="w-full align-top">
                <div>
                  <img src="{{ asset('assets/images/logo-erp.png') }}" class="h-12" />
                </div>
              </td>
                      ...
                      <tr>
                        <td class="border-r pr-4">
                          <div>
                            ...
                            <p class="whitespace-nowrap font-bold text-main text-right">{{ $invoice->created_at->format('Y-m-d') }}</p>
                          </div>
                        </td>
                        <td class="pl-4">
                          <div>
                            <p class="whitespace-nowrap text-slate-400 text-right">Invoice #</p>
                            <p class="whitespace-nowrap font-bold text-main text-right">{{ $invoice->invoice_no }}</p>
                          </div>
                        </td>
                      </tr>
                    </tbody>
          ...
          <tbody>
            <tr>
              ...
              <td class="w-1/2 align-top text-right">
                <div class="text-sm text-neutral-600">
                  <p class="font-bold">{{ $customer->full_name }}</p>
                  <p>Number: {{ $customer->mobile_no }}</p>
      ...
      <div class="px-14 py-10 text-sm text-neutral-700">
        ...
        @endphp
            ...
            <tr>
                <td class="border-b py-3 pl-3">{{ $i++ }}</td> <!-- Increment the counter -->
                <td class="border-b py-3 pl-3">
                    <img
                        src="{{ asset('assets/images/' . $item->product->product_image) }}"
                        alt="Product Image"
                        class="object-cover" style="width: 80px; height: 80px; border-radius: 50%;  border: 2px solid #ddd; padding: 2px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.2);">
                </td>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="border-b p-3 text-right">
                                <div class="whitespace-nowrap font-bold text-main">{{ $amount }}.00</div>
                              </td>
                            </tr>
                            {{-- <tr>
                              <td class="p-3">
      ...
      <div class="px-14 text-sm text-neutral-700">
        ...
        <p>Payment Method: {{ $payment_mode }}</p>
        <p>Payment Reference: {{ $payment_reference }}</p>
