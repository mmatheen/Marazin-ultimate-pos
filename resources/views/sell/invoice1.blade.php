                        ...
                        @foreach ($items as $item)
                            <tr>
                                ...
                                <td class="border-b py-3 pl-3">
                                    <img src="{{ asset('assets/images/' . $item->product->product_image) }}"
                                        alt="Product Image" class="object-cover"
                                        style="width: 80px; height: 80px; border-radius: 50%;  border: 2px solid #ddd; padding: 2px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.2);">
                                </td>
