                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <div class="input-group local-forms d-flex">
                                            <select class="form-control form-select select2Box" id="customer-id"
                                                name="customer_id">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group local-forms calendar-icon">
                                        ...
                                        <input class="form-control datetimepicker" id="sales_date" name="sales_date"
                                    ...
                                    <table class="datatable table table-stripped" id="addSaleProduct">
                                        <thead>
                                            <tr>
                                                <th>Product</th>
                                                <th>Quantity</th>
                                                @if($canUseFreeQty ?? false)<th>Free Qty</th>@endif
                                                <th>Unit Price</th>
                                                <th>Discount</th>
                                                <th>Price inc.Dis</th>
                                                <th>Subtotal</th>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                <div class="input-group local-forms">
                                                    ...
                                                    <select class="form-control form-select" id="discount_type"
                                                        name="discount_type">
                                            ...
                                            <div class="mb-3">
                                                <div class="input-group local-forms">
                                                    ...
                                                    <input class="form-control" id="discount_amount"
                                                        name="discount_amount" type="text"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Paid Amount"
                                                        id="paid-amount" name="total_paid">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control datetimepicker" type="text"
                                                    name="payment_date" id="payment-date" placeholder="DD-MM-YYYY">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="payment-fields" id="cheque-details" style="display: none;">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="cheque-date"
