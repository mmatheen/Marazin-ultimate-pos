...
function addProductToTable(product) {
    ...
    const batches = Array.isArray(product.batches) ? product.batches.flatMap(batch =>
        // Check if batch.location_batches exists and is an array
    ...
    batchDropdown.on('change', () => {
        ...
        const batchQuantity = parseInt(selectedOption.data('quantity'), 10) || 0;
    ...
    const saleId = pathSegments[pathSegments.length - 1] === 'add_sale' ? null : pathSegments[pathSegments.length - 1];
