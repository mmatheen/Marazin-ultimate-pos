            ...
            <tr>
                ...
                <td>
                    ...
                    $('#amount-given').on('input', function() {
                        let amountGiven = parseFormattedAmount($(this).val()) || 0;  // Default to 0 if empty
                        $(this).val(amountGiven ? formatAmountWithSeparators(amountGiven) : ''); // Show empty when cleared
                    });
