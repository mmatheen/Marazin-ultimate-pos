...
document.addEventListener("DOMContentLoaded", function() {
    ...
    categoryBackBtn.addEventListener('click', fetchAllProducts);
    brandBackBtn.addEventListener('click', fetchAllProducts);
    ...
    document.getElementById('cash').addEventListener('click', function() {
        ...
        productRows.forEach(row => {
            ...
            const subtotal = parseFloat(row.querySelector('td:nth-child(4)').textContent.trim());
            const productId = row.querySelector('.product-id').textContent.trim();
