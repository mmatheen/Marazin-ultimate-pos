...
<head>
    ...
    <style>
        ...
        .receipt-box {
            ...
            margin: 0 auto;
            overflow: hidden;
            height: auto; /* Ensure no extra space */
        }
        ...
        @media print {
            ...
            .receipt-box {
                ...
                padding: 5px;
                margin: 0;
                height: auto !important; /* Ensure no extra gap at bottom */
            }
            ...
            <tbody>
                @foreach ($products as $index => $product)
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <del>{{ number_format($product->product->max_retail_price, 2) }}</del> ({{ number_format($product->product->max_retail_price - $product->price, 2) }})
                        </td>
