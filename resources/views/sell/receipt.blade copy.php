        ...
        <div class="billAddress" style="font-size: 12px; color: #000; margin: 0; padding: 0; text-align: center;">
            @if ($location)
                @if ($location->logo_image && $location->name)
                    <div style="font-size: 18px ; font-weight: bold;">{{ $location->name }}</div>
                @endif
                @if ($location->address)
                ...
                <tr>
                    ...
                    <td valign="top" style="padding: 1px 2px !important;">
                        ...
                        @if($mrp > 0 && $mrp > $selling_price)
                            <span style="text-decoration: line-through; font-size: 11px; color: #000; font-weight: bold;">
                                {{ number_format($mrp, 0, '.', ',') }}
                            </span>
                            <span style="font-size: 10px; color: #000000b9;">({{ number_format($line_discount, 0, '.', ',') }})</span>
                        @endif
                    </td>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td width="100" align="right" style="font-size: 18px; font-weight: bold; white-space: nowrap;">
                                       RS {{ number_format($customer_outstanding, 0, '.', ',') }}
                                </td>
                            </tr>
                        @endif
                    @endif
