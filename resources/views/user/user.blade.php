    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <form id="addAndUserUpdateForm">
                <div id="addAndEditModal" class="modal fade" id="staticBackdrop" data-bs-backdrop="static"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-5">
                                            <div class="input-group local-forms">
                                                ...
                                                <select id="edit_role_name" name="roles"
                                                    class="roleDropdown form-control form-select">
                                        ...
                                        <div class="mb-5">
                                            <div class="input-group local-forms">
                                                ...
                                                <select id="edit_location_id" name="location_id[]"
                                                    class="locationDropdown form-control form-select" multiple>
                        ...
                        <div class="modal-btn delete-action">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <button type="submit"
                                            class="confirm_user_delete_btn btn btn-primary paid-continue-btn"
