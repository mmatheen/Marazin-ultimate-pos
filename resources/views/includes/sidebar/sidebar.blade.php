        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu {{ set_active(['supplier']) }}">
                    <a href="#"><i class="fas fa-chalkboard-teacher"></i> <span> Contacts</span> <span class="menu-arrow"></span></a>
                    <ul>
                        @can('view supplier')
            ...
            <li class="submenu {{ set_active(['list-purchase'])}}">
                <a href="#"><i class="fas fa-book-reader"></i> <span>Purchases</span> <span class="menu-arrow"></span></a>
                <ul>
                    @can('view purchase')
            ...
            <li class="submenu">
                <a href="#"><i class="fas fa-file-invoice-dollar"></i> <span>Reports</span> <span class="menu-arrow"></span></a>
                <ul>
            ...
            <li class="submenu">
                <a href="#"><i class="fas fa-file-invoice-dollar"></i> <span>Settings</span> <span class="menu-arrow"></span></a>
                <ul>
                    @can('view location')
