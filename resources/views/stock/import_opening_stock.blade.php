            ...
            <div class="row align-items-center">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="students.html">Import Opening Stock</a></li>
                            <li class="breadcrumb-item active">List Of Import Opening Stock</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card card-table">
                <div class="card-body">
                    <div class="page-header">
                        <div class="row align-items-center">
                            <form action="#" id="importOpeningStockForm" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <a class="btn btn-outline-primary mt-2 me-2" id="export_btn" href="{{ route('excel-export-student') }}"><i class="fas fa-download"></i> &nbsp; Download</a>
                                            <a class="btn btn-outline-success mt-2" id="export_btn" href="{{ route('excel-blank-template-export') }}"><i class="fas fa-download"></i> &nbsp; Download template file</a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Stock expiry date in Business date format
                                                        <b>dd-mm-yyyy, Type: text, Example: 12-09-2024</b></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
